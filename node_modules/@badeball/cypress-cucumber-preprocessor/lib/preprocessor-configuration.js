...
exports.resolve = exports.PreprocessorConfiguration = exports.DEFAULT_POST_10_STEP_DEFINITIONS = exports.DEFAULT_PRE_10_STEP_DEFINITIONS = exports.stringToMaybeBoolean = void 0;
...
class PreprocessorConfiguration {
    ...
    get stepDefinitions() {
        var _a;
        return ((_a = this.environmentOverrides.stepDefinitions) !== null && _a !== void 0 ? _a : this.explicitValues.stepDefinitions);
    }
    get messages() {
